...
public final class SequenceNumber {
    ...
    public SequenceNumber(@com.novi.serde.Unsigned Long value) {
    ...
    public static SequenceNumber deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
    ...
    public static SequenceNumber bincodeDeserialize(byte[] input) throws com.novi.serde.DeserializationError {
        if (input == null) {
             throw new com.novi.serde.DeserializationError("Cannot deserialize null array");
        }
        com.novi.serde.Deserializer deserializer = new com.novi.bincode.BincodeDeserializer(input);
        SequenceNumber value = deserialize(deserializer);
