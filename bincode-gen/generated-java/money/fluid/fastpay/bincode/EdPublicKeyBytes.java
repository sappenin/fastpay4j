...
public final class EdPublicKeyBytes {
    public final java.util.@com.novi.serde.ArrayLen(length=32) List<@com.novi.serde.Unsigned Byte> value;

    public EdPublicKeyBytes(java.util.@com.novi.serde.ArrayLen(length=32) List<@com.novi.serde.Unsigned Byte> value) {
    ...
    public static EdPublicKeyBytes deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
    ...
    public static EdPublicKeyBytes bincodeDeserialize(byte[] input) throws com.novi.serde.DeserializationError {
        if (input == null) {
             throw new com.novi.serde.DeserializationError("Cannot deserialize null array");
        }
        com.novi.serde.Deserializer deserializer = new com.novi.bincode.BincodeDeserializer(input);
        EdPublicKeyBytes value = deserialize(deserializer);
    ...
    public boolean equals(Object obj) {
        ...
        EdPublicKeyBytes other = (EdPublicKeyBytes) obj;
    ...
    public static final class Builder {
        ...
        public EdPublicKeyBytes build() {
            return new EdPublicKeyBytes(
                value
            );
        }
    }
