...
public final class ConfirmationOrder {
    ...
    public ConfirmationOrder(CertifiedTransferOrder transfer_certificate) {
    ...
    public static ConfirmationOrder deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
    ...
    public static ConfirmationOrder bincodeDeserialize(byte[] input) throws com.novi.serde.DeserializationError {
        if (input == null) {
             throw new com.novi.serde.DeserializationError("Cannot deserialize null array");
        }
        com.novi.serde.Deserializer deserializer = new com.novi.bincode.BincodeDeserializer(input);
        ConfirmationOrder value = deserialize(deserializer);
    ...
    public boolean equals(Object obj) {
        ...
        ConfirmationOrder other = (ConfirmationOrder) obj;
    ...
    public static final class Builder {
        ...
        public ConfirmationOrder build() {
